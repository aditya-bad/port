...
echo "     (or just run create_local_schema.py from inside '$APP_CONTAINER'"
echo "     directly, since it already has asyncpg installed — see that"
echo "     script's own --help)"
